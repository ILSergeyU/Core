...
Ниже приведён пример кода рассмотренной ранее программы, в котором была допущена ошибка.
 Использя режим дебага постарайтесь найти строчку программы, в которой эта ошибка была
 допущена. В поле ответа введите название переменной, объявленной в строчке с ошибкой
