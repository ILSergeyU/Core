...
public class Lesson7_2_13 {

    public static class Transfer<T> {

        private final String from;
        private final String to;
        private final T content;

        public Transfer(String from, String to, T content) {
            this.from = from;
            this.to = to;
    ...
    public static class MailMessage extends Transfer<String> {
    ...
    public static class Salary extends Transfer<Integer> {
    ...
    public static class MailService<T> implements Consumer<Transfer<T>> {
        ...
        @Override
        public void accept(Transfer<T> transfer) {
            List contents = mailBox.getOrDefault(transfer.getTo(), new ArrayList<>());
            contents.add(transfer.getContent());
            mailBox.put(transfer.getTo(), contents);
        }
    }
